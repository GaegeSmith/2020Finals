...
ketchup = abs(int(input("How many ketchup packets do you want? $0.25 per packet ")) * 0.25) #ketchup packets
total += ketchup
...
order = order + 'Your order is a {0} sandwich, a {1} drink, a {2} fry, and {3} ketchup packet(s) \nfor a total of '.format(samich,drink,fries,int(ketchup/0.25)) + ('${:,.2f}'.format(total))
print(order)
